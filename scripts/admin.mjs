...
async function snapshotDe(id) {
  ...
  const [goals, constraintRows, baselines, equipment, exercises, mapeos, conditions] =
    await Promise.all([
      ...
      pick(
        'exercises',
        'id, gym_id, name, pattern, primary_muscles, secondary_muscles, modality, is_compound, is_unilateral, is_explosive, loads_spinal_flexion, head_below_heart, requires_movements, prevents, jump_direction, skill_level, cues, is_active',
        { is_active: true },
      ),
  ...
  return {
    ...
    gym: {
      ...
      exercises: exercises.map((e) => ({
        ...
        prevents: e.prevents,
        jumpDirection: e.jump_direction,
