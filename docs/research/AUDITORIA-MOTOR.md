...
| 37 | `37-explosivos-y-deporte.md` | **Pedido del dueño: que las estaciones se puedan usar y que el deporte traiga movimiento.** Medido: 32 de 68 ejercicios no entraban a ningún plan, entre ellos los nueve explosivos; ningún plan de potencia ni de deporte recibía uno. Se resolvió la decisión abierta de `22` con el formato que la evidencia sostiene: el explosivo va en par con el levantamiento de su patrón, serie por serie (Thapa 2024, DOI 10.1080/02640414.2024.2391657; Zhao 2026, DOI 10.1186/s13102-026-01531-0). Bloque `explosive` nuevo, `confidence: "low"`. Seis estaciones de implementos pasan de `none` a `kg`, con el peso visto en las fotos. |
| 38 | `38-como-procesa-el-motor.md` | **Barrido de 3.000 socios generados** (`tools/motor-barrido.test.ts`, en `npm run check`). Cambiar solo los minutos declarados o los días sin entrenar no cambia el plan (0 %); la edad lo cambia en el 25 %. 9 ejercicios y 7 estaciones no entran nunca. Hueco más firme: mayores sin equilibrio, con fuerza sola, que es justo lo que la Cochrane no puede sostener para caídas (Sherrington 2019, DOI 10.1002/14651858.cd012424.pub2). Propuesta en tres etapas, con la forma de EXPERT: módulos de contexto en el ruleset y un único combinador. |
| 39 | `39-equilibrio-en-mayores.md` | **T1a: equilibrio desde los 60.** No había ningún ejercicio ni patrón de equilibrio; a los 76 tocaba fuerza sola, lo que la Cochrane no sostiene para caídas. Entra un bloque al final de cada sesión (4 ejercicios, piso del ICFSR; 2 × 10, 60 s), tomado de Otago; patrón `balance` nuevo y seis ejercicios en el catálogo. Discos y pelotas suizas quedan afuera (Kümmel 2016: el equilibrio es específico de la tarea). Barrido: la sensibilidad de la edad pasó del 25 % al 68 %; las sesiones que pasan los minutos declarados, del 15 % al 22 % (lo resuelve T4). | Hecho, 18/09/2026. Edad de corte (60 o 65) a confirmar por el dueño |
| 40 | `40-fragilidad.md` | **T1b: fragilidad.** El ICFSR no da receta aparte: mismos parámetros, arrancando liviano, y pide 4 a 10 ejercicios de equilibrio (el bloque de `39` pasó de 3 a 4). No se deduce de la edad sola. Propuesta: medirla en la sesión con la prueba de pararse de la silla en 30 s, con los cortes del CDC por edad y sexo. | Investigado. Espera la decisión del dueño; se construiría con T7 |
| 41 | `41-adolescentes.md` | **T1c: de 13 a 17 años.** Un chico de 14 que empezaba recibía 3 × 5–8 en fuerza y 3 × 1–3 en potencia. Ahora, principiante o novato: como máximo 2 series de 8–15 con cualquier objetivo (CSEP 2008) y un aviso de entrenar con el profe mirando. Con más experiencia, la dosis del adulto. De paso, el aviso "tu nivel no cambia la dosis" ya no sale cuando la dosis de adolescentes sí la cambió. | Hecho, 18/09/2026. Lloyd 2014 citado solo por su resumen (texto completo detrás de un control anti-bots) |
| 42 | `42-menopausia-y-hueso.md` | **T1d: después de la menopausia.** El motor no leía el sexo. Ahora las mujeres de 50 o más sin molestias cierran cada sesión con 50 impactos (5 × 10 de pisadas fuertes o saltitos), antes del equilibrio. Fuentes: consenso británico de osteoporosis 2022 y Kistler-Fischbacher 2021. La edad sale de Schoenaker 2014 (media 48,8; Latinoamérica ~3 años antes). Patrón `impact` nuevo. El bloque de equilibrio pasó a ser un caso de "bloques de contexto" (`BloqueDeContexto`). Sensibilidad del sexo: 7 %. | Hecho, 18/09/2026. Lo de osteoporosis y fractura vertebral queda para T2 |
| 43 | `43-salud-con-puerta.md` | **T2a: salud con puerta.** El cribado actual bloquea a cualquiera con diagnóstico de presión alta o que tome su medicación, y ninguna condición cambia el plan. El PAR-Q+ 2023 es la puerta con seguimiento que pidió el dueño: 7 preguntas, y con un "sí" se abren solo los grupos que correspondan; con todo el seguimiento en "no", queda habilitado. ACSM 2015: derivar por factores de riesgo es una barrera sin beneficio. | Investigado. Esperan al dueño: aflojar el bloqueo (a/b) y la licencia del PAR-Q+ |
| 44 | `44-presion-y-corazon.md` | **T2b: presión, corazón y betabloqueantes.** La presión la dispara acumular repeticiones hacia el fallo y aguantar el aire, no la carga (Gjøvaag 2016: 15RM sube más que 4RM). Módulo `salud`: piso de RIR 2 con presión o corazón (el disparador de "subimos la carga" se corre lo mismo, y la revisión de progreso usa la misma dosis que el plan); avisos de respirar y de vuelta a la calma; con betabloqueantes, la tarjeta de cardio sin el % de pulso. Tabla `user_health_conditions`. | Hecho: motor, base, barrido (salud mueve el plan en el 10 %) y pantalla (puerta sí/no en el registro y en Perfil; la tarjeta de cardio sin % de pulso con betabloqueantes). Del dueño: isométricos (a/b/c) |
| 45 | `45-diabetes-y-anticoagulantes.md` | **T2c: diabetes y anticoagulantes.** Diabetes: la dosis no se baja, porque la fuerza intensa es la que más mejora la glucosa (ACSM 2022). Avisos de hipoglucemia (insulina o secretagogos) y los umbrales de 250 con cetonas y 300 sin cetonas. Con betabloqueantes, el aviso de síntomas tapados (`withOther`, nuevo en el esquema). Anticoagulantes: la actividad se asocia con **menos** sangrado mayor (Frey 2015, Shendre 2014); no cambian el plan. "Fuerza antes que aeróbico" (Yardley 2012) no tiene dónde actuar: ninguna plantilla pone cardio antes de fuerza. | Hecho y en prod. Neuropatía y retinopatía esperan (la lista no pregunta complicaciones; retina es T2e) |
| 46 | `46-osteoporosis-suelo-pelvico-hernia.md` | **T2d.** Osteoporosis: sin ejercicios que flexionen el tronco (atributo nuevo `loads_spinal_flexion`) y con bloque de impacto para cualquier sexo y edad (consenso británico 2022). Suelo pélvico: sin impacto ni saltos mientras haya pérdidas, y kinesiología (Cochrane 2018: cura el 56 % contra el 6 %); gana sobre la osteoporosis. Hernia: el plan no cambia, sale el aviso de urgencia (HerniaSurge 2018). El barrido destapó que el catálogo no tenía core de columna neutra: se sumaron Pallof press y Dead bug, y con una molestia lo explosivo sale también de los slots comunes. | Hecho y en prod (ruleset, catálogo, migración). 20 de 43 perfiles de la matriz cambian algún ejercicio. Artrosis y columna quedan para T3 |
| 47 | `47-ojos-epilepsia-respiracion.md` | **T2e.** Glaucoma o retina: la presión del ojo sube con el esfuerzo hacia el fallo (Vera 2020) y se duplica con la cabeza abajo (Baskaran 2006). Piso de RIR 2, sin banco declinado (atributo nuevo `head_below_heart`), aviso de respirar y de consultar si hay retinopatía activa. Asma: broncodilatador antes (ATS 2013). EPOC: sin cambios (Liao 2015). Epilepsia: **pendiente**, porque la tabla de riesgo por deporte de ILAE 2016 no se pudo abrir. | Hecho y en prod, salvo epilepsia y vértigo |
| 48 | `48-embarazo-y-posparto.md` | **T2f.** Embarazo: la dosis no cambia (OMS 2020; Prevett 2025; Moolyk 2025, fuerza al 90 % de 10RM sin bradicardia fetal); salen saltos, lanzamientos e impacto por riesgo de caída; avisos de boca arriba desde el cuarto mes, señales de alarma y calor. Posparto: sin impacto los primeros tres meses (consenso Asia-Pacífico 2021, el dato más flojo), suelo pélvico desde el principio (Beamish 2025). El aviso de potencia ya no inventa la razón cuando los explosivos los saca la salud. `specialPopulations.pregnancy` sigue sin consumir. | Hecho y en prod |
| 49 | `49-dolor-de-cadera.md` | **T3a.** Regla de dolor para la cadera, que `27` había dejado sin regla. La fuerza es el tratamiento en tendinopatía glútea (LEAP 2018: 77 % contra 29 %), artrosis (EULAR 2023) y dolor de cadera en activos (Kemp 2020); lo que empeora son la sentadilla profunda y las escaleras (Pianka 2021). Con 7 de 10 salen zancadas, y sentadillas; bisagras y glúteo siguen. Invariante nueva en el barrido: lo que saca una regla de dolor no vuelve a entrar. | Hecho y en prod |
| 50 | `50-dolor-de-tobillo.md` | **T3b.** Regla de dolor para el tobillo. Guía holandesa de Aquiles 2021: parar lo que provoca (correr, saltar: ya salía con cualquier molestia) y fortalecer la pantorrilla 12 semanas. Esguince: tratamiento funcional y equilibrio contra las recaídas (revisión paraguas 2022). Desde 7 de 10 salen las zancadas; gemelos y equilibrio siguen. Cuándo consultar: no dar cuatro pasos (Ottawa, Bachmann 2003) o chasquido en el talón. | Hecho y en prod |
| 51 | `51-dolor-de-codo.md` | **T3c.** Regla de dolor para el codo. Con ejercicio mejora antes que esperando y la infiltración recae (Bisset 2006, 198 personas); el tendón se carga al agarrar (Bhabra 2016). Desde 7 de 10 sale el agarre puro; con "no puedo", el curl. Los tirones siguen con correas. Falta un ejercicio de extensores de muñeca en el catálogo. | Hecho y en prod |
| 52 | `52-dolor-de-espalda-alta.md` | **T3d.** Regla de dolor para la espalda alta; con ella todas las zonas menos "otra" tienen regla. Frecuente y mecánico (Briggs 2009), sin tratamiento propio: nada sale hasta "no puedo"; con eso o una lesión, la carga axial directa. Consultar por golpe, corticoides o cáncer (Downie 2013, las señales que sí informan) o dolor que va al pecho. | Hecho y en prod |
| 53 | `53-artrosis-y-protesis.md` | **T3e.** Artrosis: ejercicio para todos (EULAR 2023), la dosis no cambia, un aviso que la conecta con las reglas por zona. Prótesis (nueva, `joint_replacement`): 8 de 10 vuelven al deporte en 16-28 semanas (Hoorntje 2018); sin saltos ni impacto por consenso de 549 cirujanos (opinión de expertos); las precauciones de cadera no sirven (Barnsley 2015), así que la flexión profunda queda. | Hecho y en prod |
| 54 | `54-hernia-de-disco-y-columna.md` | **T3f.** Hernia de disco o columna: sin cambios en la dosis (Fernandez 2015: mantenerse activo = ejercicio a largo plazo; Yu 2022: 62-66 % se reabsorben; Sedrak 2021: 81,5 % de atletas vuelve sin cirugía). La regla de dolor lumbar no tenía las señales de cauda equina (Dionne 2019); ahora sí. | Hecho y en prod |
| 55 | `55-tendinopatia-y-puerta-de-lesiones.md` | **T3g.** La app no tenía dónde declarar una lesión: toda restricción nacía del reporte de dolor como `pain`. Puerta de lesiones nueva (registro y perfil). Tendinopatía como tipo propio: la carga es el tratamiento (Kongsgaard 2009, Pavlova 2023) y seguir con dolor controlado no empeora (Silbernagel 2007), así que va por la vía del dolor crónico, no la de lesión. | Hecho y en prod |
| 56 | `56-operacion-y-hace-cuanto.md` | **T3h.** Operación como tipo propio, con mes y rehabilitación. En rehabilitación, la zona sale entera y el aviso es el de rehab, no el de dolor. Con el alta, rodilla sin saltos ni impacto hasta los 9 meses (Grindem 2016: -51 % de reinjuria por mes de demora hasta los 9). | Hecho y en prod |
| 57 | `57-esguince-de-tobillo.md` | **T3i.** Esguince de tobillo con mes: 12 meses de equilibrio en un pie al final de cada sesión (Vuurberg 2018 RR 0,62, efecto hasta 12 meses; Hupperets 2009 NNT 9; la dosis no está estandarizada y el volumen no predice el efecto). No es molestia. Cuatro ejercicios unilaterales nuevos; el que dobla la rodilla con carga cuenta como zancada para el dolor. | Hecho y en prod |
| 58 | `58-movimientos-que-no-puede.md` | **T3j.** Movimientos que no puede (brazos arriba, piso, colgarse, saltar): exclusión con sustitución, sin dosis. Cada ejercicio marca lo que pide; saltar se marca a mano porque deducirlo de lo explosivo sacaba lanzamientos y pisadas. Si se vacía un patrón, el aviso nombra el movimiento, haya o no sustituto. Aviso de piso: levantarse se reaprende practicando (guía mundial 2022; Tinetti 1993, 47 % no se levanta solo). | Hecho y en prod |
| 59 | `59-minutos-por-sesion.md` | **T4a.** Los minutos arman la sesión: 30 s por serie más la pausa (Schoenfeld 2019). Si no entra: pausa al piso del nivel (Grgic 2017, Singer 2024), pares sin músculo en común ni peso libre (Iversen 2021: mitad del tiempo), aislados, series sin bajar del mínimo semanal del objetivo, y los bloques al final. Sensibilidad de los minutos 0 % → 69 %. El cardio continuo no se achica: pregunta para el dueño. | Hecho y en prod |
| 60 | `60-la-pausa-del-principiante.md` | **T4b.** El ×1,2 de pausa del principiante (`04`, "ACSM 2009") no tiene fuente: ACSM no lo dice y Grgic 2017 da 60-120 s para no entrenados; Singer 2024, nada por encima de 90 s en hipertrofia. Principiante de fuerza 120/90/90 s; de hipertrofia y recomposición 90 s. El descanso no se pregunta: lo gobiernan los minutos. | Hecho y en prod |
| 61 | `61-cardio-y-minutos.md` | **T4c.** El cardio continuo se acorta con los minutos; su piso es semanal (OMS 2020: 150 moderados; cualquier tramo suma, Jakicic 2019; zonas por la tabla de ACSM en MacIntosh 2021). Aviso solo cuando el tiempo lo acortó. Hallazgo: la plantilla de cardio no llega a 150 con ninguna frecuencia (72-144), para T6. | Hecho y en prod |
| 62 | `62-prevencion-por-deporte.md` | **T5a.** Curl nórdico como bloque de prevención para deportes de pique (van Dyk 2019: RR 0,49; Cuthbert 2020: 2×4-6 alcanza). Va en las sesiones de pierna, en temporada en una sesión de la plantilla, y sale el día antes, el del partido y el siguiente. Aviso del FIFA 11+ en fútbol y futsal. Esquema nuevo: `exercises.prevents`. Hallazgo: la sesión de pierna se definía por cualquier músculo de pierna y el ajuste al tiempo dejaba un torso con nórdico; ahora es por multiarticular. Límite: en temporada sale 1,2 veces por semana en promedio (máx. 2) porque la plantilla rota. | Hecho y en prod |
| 63 | `63-prevencion-de-rodilla.md` | **T5b.** Dos aterrizajes (desde cajón y lateral a un pie) como bloque de rodilla para los deportes de giro. Base: los programas neuromusculares bajan las roturas de cruzado a la mitad (Huang 2020: 0,47; Watson 2026: 0,46), sobre todo con pliométricos (Al Attar 2022: 0,40). Van en toda sesión de pierna, también en temporada, porque Sugimoto 2014 muestra que dos o más por semana rinde más. Son explosivos: salen con la regla del día y con cada exclusión de saltos. Se cerraron dos fugas de `isExplosive` (el aviso de potencia y la razón por movimientos). Hallazgo aparte: la guarda "el tiempo cambió reps o RIR" del barrido indexaba solo por ejercicio. | Hecho y en prod |
| 64 | `64-hombro-en-deportes-de-brazo-arriba.md` | **T5c.** Sin bloque de hombro: hay un solo ensayo bueno (Andersson 2017, handball de élite: OR 0,72 en problemas; no significativo en los importantes), el programa no movió sus factores de riesgo (Fredriksen 2020) y la revisión de Wright 2021 no saca conclusiones. Queda un aviso de entrada en calor solo en handball. La rotación externa con banda sigue en slot. | Hecho y en prod |
| 65 | `65-temporada-y-dia-de-partido.md` | **T5d.** Hallazgo: la app nunca preguntaba la temporada (`season_phase` siempre `none`) ni el partido (`adjustSession` sin llamador), así que ni el recorte en temporada ni el ajuste del día de partido le llegaban a nadie. Ahora la temporada se pregunta en el onboarding y se edita en Perfil. En temporada con un deporte de partidos se pide un día fijo, y Hoy deduce el estado de la fecha (`estadoDelDia`, puro) y lo deja corregir (`match_exceptions`). La sesión que se muestra pasa por `adjustSession`, y el estado queda en `workout_logs`. `daysFromMatch` en el ruleset. | Hecho y en prod; falta la prueba en el navegador |
| 66 | `66-lo-que-el-deporte-no-cambia.md` | **T5e y T5f.** No se pregunta la carga semanal del deporte: el aeróbico sumado no reduce la fuerza máxima ni la hipertrofia, y su frecuencia no modera el efecto (Schumann 2022). El mantenimiento en temporada ya está. Tampoco se pregunta la categoría de peso: es nutrición y deshidratación, y la fuerza vuelve al rehidratarse (Brechney 2022). | Decidido, sin código |
| 67 | `67-el-salto-del-par.md` | **T5g.** Ni puesto ni qué mejorar: no hay intervención por puesto, y la dirección del salto da la misma respuesta para todos. La horizontal rinde igual en lo vertical y más en lo horizontal (Moran 2021, ES 0,65). El par prefiere el salto horizontal (`exercises.jump_direction`, `explosive.preferJumpDirection`). De paso: lo explosivo nunca ocupa un slot. | Hecho |
| 68 | `68-objetivos-secundarios-y-cardio.md` | **T6a.** Bajar grasa y salud como secundarios, en orden. Los dos piden 150 minutos semanales de cardio: el piso de la OMS y el umbral clínico de Jayedi 2024 (116 ensayos, lineal hasta 300). También lo piden los principales cardio y recomposición. Se suma con el tiempo que sobra, después del ajuste: nunca le saca nada al principal. Si no alcanza, se dice cuánto suma la semana. | Hecho |
| 69 | `69-cambiar-ejercicio-filtra-igual.md` | **Tanda propia.** El plan filtraba por cuatro módulos (restricción, molestia, nivel, salud) y `findSubstitutes` tenía su propia lista con dos. Medido sobre el catálogo real: salto en profundidad a una embarazada, crunch en polea con osteoporosis, abdominales en camilla con glaucoma, peso muerto a un principiante. Y las tres pantallas le pasaban solo las molestias. Ahora los dos caminos usan `exclusionesDelSocio`; el contrato pide `user`. No cambia ningún plan. | Hecho |
